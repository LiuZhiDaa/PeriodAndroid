...
import ulric.li.billing.utils.UtilsBilling;
...
public class BillingManager implements PurchasesUpdatedListener {
     ...
     */
//    private static final String BASE_64_ENCODED_PUBLIC_KEY = "";
    ...
    public interface BillingUpdatesListener {
        ...
        void onPurchasesUpdated(List<Purchase> purchases, int nResultCode);
    }
    ...
    private boolean verifyValidSignature(String signedData, String signature) {
        ...
        if (UtilsBilling.getBillingPbulicKey().contains("CONSTRUCT_YOUR")) {
            throw new RuntimeException("Please update your app's public key at: "
                    + "BASE_64_ENCODED_PUBLIC_KEY");
        }

        try {
            return Security.verifyPurchase(UtilsBilling.getBillingPbulicKey(), signedData, signature);
        } catch (IOException e) {
